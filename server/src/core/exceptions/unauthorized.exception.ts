...
export class UnauthorizedException extends HttpException {
    ...
    static TOKEN_EXPIRED_ERROR = (msg?: string) => {
        return new UnauthorizedException({
            ...
            statusCode: ExceptionConstants.UnauthorizedCodes.TOKEN_EXPIRED_ERROR,
        });
    };
    ...
    static JSON_WEB_TOKEN_ERROR = (msg?: string) => {
        return new UnauthorizedException({
            ...
            statusCode: ExceptionConstants.UnauthorizedCodes.JSON_WEB_TOKEN_ERROR,
        });
    };
    ...
    static UNAUTHORIZED_ACCESS = (description?: string) => {
        return new UnauthorizedException({
            ...
            statusCode: ExceptionConstants.UnauthorizedCodes.UNAUTHORIZED_ACCESS,
            description,
        });
    };
    ...
    static RESOURCE_NOT_FOUND = (msg?: string) => {
        return new UnauthorizedException({
            ...
            statusCode: ExceptionConstants.UnauthorizedCodes.RESOURCE_NOT_FOUND,
        });
    };
    ...
    static USER_NOT_VERIFIED = (msg?: string) => {
        return new UnauthorizedException({
            ...
            statusCode: ExceptionConstants.UnauthorizedCodes.USER_NOT_VERIFIED,
        });
    };
    ...
    static UNEXPECTED_ERROR = (error: any) => {
        return new UnauthorizedException({
            ...
            statusCode: ExceptionConstants.UnauthorizedCodes.UNEXPECTED_ERROR,
            cause: error,
        });
    };
    ...
    static REQUIRED_RE_AUTHENTICATION = (msg?: string) => {
        return new UnauthorizedException({
            ...
            statusCode: ExceptionConstants.UnauthorizedCodes
