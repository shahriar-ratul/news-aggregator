...
export class BadRequestException extends HttpException {
    ...
    static HTTP_REQUEST_TIMEOUT = () => {
        return new BadRequestException({
            ...
            statusCode: ExceptionConstants.BadRequestCodes.HTTP_REQUEST_TIMEOUT,
        });
    };
    ...
    static RESOURCE_ALREADY_EXISTS = (msg?: string) => {
        return new BadRequestException({
            ...
            statusCode: ExceptionConstants.BadRequestCodes.RESOURCE_ALREADY_EXISTS,
        });
    };
    ...
    static RESOURCE_NOT_FOUND = (msg?: string) => {
        return new BadRequestException({
            ...
            statusCode: ExceptionConstants.BadRequestCodes.RESOURCE_NOT_FOUND,
        });
    };
    ...
    static VALIDATION_ERROR = (msg?: string) => {
        return new BadRequestException({
            ...
            statusCode: ExceptionConstants.BadRequestCodes.VALIDATION_ERROR,
        });
    };
    ...
    static UNEXPECTED = (msg?: string) => {
        return new BadRequestException({
            ...
            statusCode: ExceptionConstants.BadRequestCodes.UNEXPECTED_ERROR,
        });
    };
    ...
    static INVALID_INPUT = (msg?: string) => {
        return new BadRequestException({
            ...
            statusCode: ExceptionConstants.BadRequestCodes.INVALID_INPUT,
        });
    };
}
